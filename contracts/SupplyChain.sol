...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  modifier verifyOwner (address _address) { require (msg.sender == owner, "no owner"); _;}
  modifier verifyCaller (address _address) { require (msg.sender == _address, "no caller"); _;}
   ...
   */
  modifier forSale (uint _sku) {require(items[_sku].state == State.ForSale && items[_sku].price != 0, "item not for sale"); _;}
